import { a as withLeadingSlash, j as joinRelativeURL, b as useRuntimeConfig, c as getResponseStatusText, d as getResponseStatus, e as defineRenderHandler, f as getQuery, h as createError, i as destr, k as getRouteRules, l as joinURL, u as useNitroApp } from '../_/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"description","content":"Frontend Developer Portfolio | Nuxt 3 & Tailwind CSS"},{"name":"viewport","content":"width=device-width, initial-scale=1"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"title":"TJ Portfolio"};
