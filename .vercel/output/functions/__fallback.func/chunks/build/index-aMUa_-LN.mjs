import { defineComponent, useSSRContext, mergeProps, ref, computed, watch, unref } from 'vue';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrRenderClass, ssrRenderTeleport, ssrRenderComponent, ssrIncludeBooleanAttr } from 'vue/server-renderer';
...
const _sfc_main$6 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const highlights = ["Vue/Nuxt", "Tailwind CSS", "API Integration", "Clean Code"];
    const topSkills = [
      { name: "Vue 3 / Nuxt 3", level: "Advanced" },
    ...
    const mobileProjects = [
      {
        title: "Ghibli App",
        description: "Movie discovery app with search and pagination.",
        image: "/projects/ghibli-app.png",
        demo: "https://exam-ghibli-app.vercel.app/"
      },
      {
        title: "Nuxt Tables",
        description: "Sortable and filterable table interface for dashboards.",
        image: "/projects/nuxt-tables.png",
        demo: "https://nuxt-tables.vercel.app/"
      },
      {
        title: "Budget Planner",
        description: "Finance tracker with categories and visual reports.",
        image: "/projects/budgetplanner.png",
        demo: "https://budget-planner-azure.vercel.app/personal-budget-planner/"
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<main${ssrRenderAttrs(mergeProps({ class: "mx-auto max-w-md px-4 pb-24 pt-24 text-slate-100" }, _attrs))}><section id="hero" class="rounded-3xl border border-cyan-400/20 bg-slate-900/80 p-5 shadow-[0_20px_45px_rgba(2,6,23,0.45)]"><p class="text-xs font-semibold uppercase tracking-[0.2em] text-cyan-300">Frontend Developer</p><h1 class="mt-2 text-2xl font-black leading-tight text-white">Hi, I&#39;m Timothy Lozada</h1><p class="mt-3 text-sm leading-relaxed text-slate-300"> I craft performant Vue/Nuxt experiences focused on clean UX and production-ready code. </p><div class="mt-4 grid grid-cols-2 gap-2 text-center"><div class="rounded-xl border border-slate-800 bg-slate-950/80 p-3"><p class="text-xl font-bold text-cyan-300">4+</p><p class="text-[11px] text-slate-400">Years Exp</p></div><div class="rounded-xl border border-slate-800 bg-slate-950/80 p-3"><p class="text-xl font-bold text-cyan-300">20+</p><p class="text-[11px] text-slate-400">Projects</p></div></div><div class="mt-4 grid grid-cols-2 gap-2"><button class="rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 px-4 py-2.5 text-sm font-semibold text-white"> View Work </button><button class="rounded-xl border border-cyan-400/30 bg-cyan-500/10 px-4 py-2.5 text-sm font-semibold text-cyan-100"> Contact </button></div></section><section id="about" class="mt-4 rounded-3xl border border-slate-800 bg-slate-900/75 p-5"><h2 class="text-lg font-bold text-white">About</h2><p class="mt-2 text-sm leading-relaxed text-slate-300"> I specialize in Vue 3 + Nuxt 3 development, building responsive interfaces with strong focus on performance, accessibility, and maintainability. </p><div class="mt-4 flex flex-wrap gap-2"><!--[-->`);
      ssrRenderList(highlights, (item) => {
        _push(`<span class="rounded-full border border-slate-700 bg-slate-950/80 px-3 py-1 text-xs text-slate-300">${ssrInterpolate(item)}</span>`);
      });
      _push(`<!--]--></div></section><section id="skills" class="mt-4 rounded-3xl border border-slate-800 bg-slate-900/75 p-5"><h2 class="text-lg font-bold text-white">Skills</h2><div class="mt-3 grid grid-cols-2 gap-2"><!--[-->`);
      ssrRenderList(topSkills, (skill) => {
        _push(`<div class="rounded-xl border border-slate-800 bg-slate-950/80 p-3"><p class="text-sm font-semibold text-slate-100">${ssrInterpolate(skill.name)}</p><p class="mt-1 text-xs text-cyan-300">${ssrInterpolate(skill.level)}</p></div>`);
      });
      _push(`<!--]--></div></section><section id="projects" class="mt-4 rounded-3xl border border-slate-800 bg-slate-900/75 p-5"><div class="flex items-center justify-between"><h2 class="text-lg font-bold text-white">Projects</h2><a href="https://github.com/Teejay-d3v" target="_blank" rel="noopener noreferrer" class="text-xs text-cyan-300"> GitHub ↗ </a></div><div class="mt-3 space-y-3"><!--[-->`);
      ssrRenderList(mobileProjects, (project) => {
        _push(`<article class="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950/85"><img${ssrRenderAttr("src", project.image)}${ssrRenderAttr("alt", project.title)} class="h-32 w-full object-cover"><div class="p-3"><h3 class="text-sm font-semibold text-white">${ssrInterpolate(project.title)}</h3><p class="mt-1 text-xs leading-relaxed text-slate-400">${ssrInterpolate(project.description)}</p><a${ssrRenderAttr("href", project.demo)} target="_blank" rel="noopener noreferrer" class="mt-2 inline-flex text-xs font-semibold text-cyan-300"> Open project ↗ </a></div></article>`);
      });
      _push(`<!--]--></div></section><section id="contact" class="mt-4 rounded-3xl border border-slate-800 bg-slate-900/75 p-5"><h2 class="text-lg font-bold text-white">Contact</h2><p class="mt-2 text-sm text-slate-300">Open for freelance and full-time opportunities.</p><div class="mt-3 grid grid-cols-2 gap-2"><a href="mailto:timlozada5@gmail.com" class="rounded-xl border border-slate-700 bg-slate-950/80 px-3 py-2 text-center text-xs text-slate-200"> Email </a><a href="https://www.linkedin.com/in/timothy-john-lozada-b7461b248/" target="_blank" rel="noopener noreferrer" class="rounded-xl border border-slate-700 bg-slate-950/80 px-3 py-2 text-center text-xs text-slate-200"> LinkedIn </a></div></section></main>`);
    };
  }
});
...
_sfc_main$6.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/MobilePage.vue");
  return _sfc_setup$6 ? _sfc_setup$6(props, ctx) : void 0;
};
const __nuxt_component_0 = Object.assign(_sfc_main$6, { __name: "MobilePage" });
const _sfc_main$5 = {
  __name: "Hero",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-section" }, _attrs))} data-v-c59bc601><div class="section-overlay" data-v-c59bc601></div><div class="floating-elements" data-v-c59bc601><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<div class="floating-circle" style="${ssrRenderStyle({
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 100}%`,
      ...
      _push(`<!--]--></div><div class="absolute inset-0 grid-pattern opacity-30" data-v-c59bc601></div><div id="skills" class="section-anchor relative z-10 w-full" data-v-c59bc601><div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16" data-v-c59bc601><div class="text-center mb-12 animate-fadeInUp" data-v-c59bc601><div class="section-badge mx-auto" data-v-c59bc601><svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c59bc601><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" data-v-c59bc601></path></svg><span data-v-c59bc601>Expertise</span></div><h2 class="section-title" data-v-c59bc601> Technical <span data-v-c59bc601>Skills</span></h2><p class="section-subtitle mt-4" data-v-c59bc601> Technologies and tools I use to build production-ready applications </p></div><div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-v-c59bc601><!--[-->`);
      ssrRenderList(skillCategories.value, (category, index2) => {
        _push(`<div class="${ssrRenderClass([`delay-${index2 * 100}`, "portfolio-card p-6 animate-fadeInUp hover:border-blue-400/50 transition-all duration-300"])}" data-v-c59bc601><div class="flex items-center gap-3 mb-6" data-v-c59bc601><div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center" data-v-c59bc601><span class="text-2xl" data-v-c59bc601>${ssrInterpolate(category.icon)}</span></div><h3 class="text-xl font-semibold text-white" data-v-c59bc601>${ssrInterpolate(category.name)}</h3></div><div class="space-y-4" data-v-c59bc601><!--[-->`);
        ssrRenderList(category.skills, (skill) => {
          _push(`<div class="group relative" data-v-c59bc601><div class="flex justify-between items-center mb-1" data-v-c59bc601><span class="text-gray-300 group-hover:text-blue-400 transition-colors" data-v-c59bc601>${ssrInterpolate(skill.name)}</span><span class="text-sm text-gray-500" data-v-c59bc601>${ssrInterpolate(skill.experience)}</span></div><div class="h-1.5 bg-white/10 rounded-full overflow-hidden" data-v-c59bc601><div class="h-full bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full transition-all duration-1000" style="${ssrRenderStyle({ width: skill.level + "%" })}" data-v-c59bc601></div></div><div class="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-1.5 bg-slate-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10 pointer-events-none z-10" data-v-c59bc601><div class="flex gap-2" data-v-c59bc601><span class="text-blue-400" data-v-c59bc601>${ssrInterpolate(skill.tags[0])}</span></div><div class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-slate-800 rotate-45 border-r border-b border-white/10" data-v-c59bc601></div></div></div>`);
        });
        _push(`<!--]--></div><div class="mt-6 pt-4 border-t border-white/10 text-sm" data-v-c59bc601><span class="text-gray-400" data-v-c59bc601>${ssrInterpolate(category.skills.length)} technologies</span></div></div>`);
      });
      _push(`<!--]--></div><div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 animate-fadeInUp delay-300" data-v-c59bc601><!--[-->`);
      ssrRenderList(stats.value, (stat) => {
        _push(`<div class="portfolio-card p-6 text-center hover:border-blue-400/30 transition-all duration-300" data-v-c59bc601><div class="text-3xl font-bold text-blue-400 mb-2" data-v-c59bc601>${ssrInterpolate(stat.value)}</div><div class="text-sm text-gray-400" data-v-c59bc601>${ssrInterpolate(stat.label)}</div></div>`);
      });
      _push(`<!--]--></div><div class="mt-16 portfolio-card p-8 animate-fadeInUp delay-400" data-v-c59bc601><div class="flex flex-col md:flex-row items-start md:items-center gap-6" data-v-c59bc601><div class="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center flex-shrink-0" data-v-c59bc601><svg class="w-8 h-8 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c59bc601><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" data-v-c59bc601></path></svg></div><div class="flex-1" data-v-c59bc601><h4 class="text-lg font-semibold text-white mb-2" data-v-c59bc601>Continuous Learning</h4><p class="text-gray-400 text-sm mb-4" data-v-c59bc601>Currently expanding my skills in these areas</p><div class="flex flex-wrap gap-3" data-v-c59bc601><!--[-->`);
      ssrRenderList(learning.value, (tech) => {
        _push(`<div class="px-4 py-2 glass-light rounded-lg text-sm flex items-center gap-2" data-v-c59bc601><span class="w-2 h-2 bg-green-400 rounded-full" data-v-c59bc601></span><span class="text-gray-300" data-v-c59bc601>${ssrInterpolate(tech.name)}</span></div>`);
      });
      _push(`<!--]--></div></div></div></div><div class="mt-16 animate-fadeInUp delay-500" data-v-c59bc601><h3 class="text-lg font-semibold text-white text-center mb-6" data-v-c59bc601>Development Ecosystem</h3><div class="flex flex-wrap justify-center gap-3" data-v-c59bc601><!--[-->`);
      ssrRenderList(tools.value, (tool) => {
        _push(`<span class="px-4 py-2 glass-light rounded-lg text-sm text-gray-300 hover:text-blue-400 hover:border-blue-400/30 transition-all duration-300 cursor-default" data-v-c59bc601>${ssrInterpolate(tool.name)}</span>`);
      });
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c59bc601"]]);
const _sfc_main$2 = {
  __name: "Projects",
  __ssrInlineRender: true,
  setup(__props) {
...
const __nuxt_component_4 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-3a80a6da"]]), { __name: "Projects" });
const _sfc_main$1 = {
  __name: "Contact",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const updateScrollProgress = () => {
      const winScroll = (void 0).documentElement.scrollTop;
      const height = (void 0).documentElement.scrollHeight - (void 0).documentElement.clientHeight;
    ...
    const setupDesktopScroll = () => {
      (void 0).addEventListener("scroll", handleScroll, { passive: true });
      updateScrollProgress();
    };
    const cleanupDesktopScroll = () => {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_MobilePage = __nuxt_component_0;
      ...
      _push(`<!--[--><div class="fixed inset-0 -z-10" data-v-ba34bb72><div class="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" data-v-ba34bb72></div><div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-transparent via-slate-900/20 to-slate-900" data-v-ba34bb72></div></div><div class="relative z-0 min-h-screen overflow-x-hidden" data-v-ba34bb72>`);
      if (unref(isMobile)) {
        _push(`<div data-v-ba34bb72>`);
        _push(ssrRenderComponent(_component_MobilePage, null, null, _parent));
        _push(`</div>`);
      } else {
        _push(`<div data-v-ba34bb72><div class="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 z-50 origin-left transition-transform duration-150" style="${ssrRenderStyle({ transform: `scaleX(${scrollProgress.value})` })}" data-v-ba34bb72></div><main class="pt-16" data-v-ba34bb72>`);
        ...
        if (showBackToTop.value) {
          _push(`<button class="fixed bottom-8 right-8 z-40 p-3 bg-slate-800/90 backdrop-blur-sm rounded-full border border-slate-700 hover:bg-slate-700/90 transition-all duration-300 hover:scale-110 group shadow-lg hover:shadow-cyan-500/20" aria-label="Back to top" title="Back to top" data-v-ba34bb72><svg class="w-6 h-6 text-cyan-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ba34bb72><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18" data-v-ba34bb72></path></svg></button>`);
        } else {
          _push(`<!---->`);
        }
        if (showScrollHint.value) {
          _push(`<div class="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-30" data-v-ba34bb72><div class="flex flex-col items-center text-sm text-slate-400 bg-slate-900/50 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-800" data-v-ba34bb72><span class="mb-1" data-v-ba34bb72>Scroll to explore</span><svg class="w-4 h-4 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-ba34bb72><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" data-v-ba34bb72></path></svg></div></div>`);
        } else {
          _push(`<!---->`);
        }
        if (isLoading.value) {
          _push(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900" data-v-ba34bb72><div class="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-cyan-500" data-v-ba34bb72></div></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-ba34bb72"]]);

export { index as default };
//# sourceMappingURL=index-aMUa_-LN.mjs.map
