...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({ class: "portfolio-section" }, _attrs))} data-v-c46b6db2><div class="section-overlay" data-v-c46b6db2></div><div class="floating-elements" data-v-c46b6db2><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<div class="floating-circle" style="${ssrRenderStyle({
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 100}%`,
      ...
      _push(`<!--]--></div><div class="absolute inset-0 grid-pattern opacity-30" data-v-c46b6db2></div><div id="skills" class="section-anchor relative z-10 w-full" data-v-c46b6db2><div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16" data-v-c46b6db2><div class="text-center mb-12 animate-fadeInUp" data-v-c46b6db2><div class="section-badge mx-auto" data-v-c46b6db2><svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c46b6db2><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z" data-v-c46b6db2></path></svg><span data-v-c46b6db2>Expertise</span></div><h2 class="section-title" data-v-c46b6db2> Technical <span data-v-c46b6db2>Skills</span></h2><p class="section-subtitle mt-4" data-v-c46b6db2> Technologies and tools I use to build production-ready applications </p></div><div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-v-c46b6db2><!--[-->`);
      ssrRenderList(skillCategories.value, (category, index2) => {
        _push(`<div class="${ssrRenderClass([`delay-${index2 * 100}`, "portfolio-card p-6 animate-fadeInUp hover:border-blue-400/50 transition-all duration-300"])}" data-v-c46b6db2><div class="flex items-center gap-3 mb-6" data-v-c46b6db2><div class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/20 to-cyan-500/20 flex items-center justify-center" data-v-c46b6db2><span class="text-2xl" data-v-c46b6db2>${ssrInterpolate(category.icon)}</span></div><h3 class="text-xl font-semibold text-white" data-v-c46b6db2>${ssrInterpolate(category.name)}</h3></div><div class="space-y-4" data-v-c46b6db2><!--[-->`);
        ssrRenderList(category.skills, (skill) => {
          _push(`<div class="group relative" data-v-c46b6db2><div class="flex justify-between items-center mb-1" data-v-c46b6db2><span class="text-gray-300 group-hover:text-blue-400 transition-colors" data-v-c46b6db2>${ssrInterpolate(skill.name)}</span><span class="text-sm text-gray-500" data-v-c46b6db2>${ssrInterpolate(skill.experience)}</span></div><div class="h-1.5 bg-white/10 rounded-full overflow-hidden" data-v-c46b6db2><div class="h-full bg-gradient-to-r from-blue-400 to-cyan-400 rounded-full transition-all duration-1000" style="${ssrRenderStyle({ width: skill.level + "%" })}" data-v-c46b6db2></div></div><div class="absolute -top-12 left-1/2 transform -translate-x-1/2 px-3 py-1.5 bg-slate-800 text-white text-xs rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap border border-white/10 pointer-events-none z-10" data-v-c46b6db2><div class="flex gap-2" data-v-c46b6db2><span class="text-blue-400" data-v-c46b6db2>${ssrInterpolate(skill.tags[0])}</span></div><div class="absolute -bottom-1 left-1/2 transform -translate-x-1/2 w-2 h-2 bg-slate-800 rotate-45 border-r border-b border-white/10" data-v-c46b6db2></div></div></div>`);
        });
        _push(`<!--]--></div><div class="mt-6 pt-4 border-t border-white/10 text-sm" data-v-c46b6db2><span class="text-gray-400" data-v-c46b6db2>${ssrInterpolate(category.skills.length)} technologies</span></div></div>`);
      });
      _push(`<!--]--></div><div class="mt-16 grid grid-cols-2 md:grid-cols-4 gap-4 animate-fadeInUp delay-300" data-v-c46b6db2><!--[-->`);
      ssrRenderList(stats.value, (stat) => {
        _push(`<div class="portfolio-card p-6 text-center hover:border-blue-400/30 transition-all duration-300" data-v-c46b6db2><div class="text-3xl font-bold text-blue-400 mb-2" data-v-c46b6db2>${ssrInterpolate(stat.value)}</div><div class="text-sm text-gray-400" data-v-c46b6db2>${ssrInterpolate(stat.label)}</div></div>`);
      });
      _push(`<!--]--></div><div class="mt-16 portfolio-card p-8 animate-fadeInUp delay-400" data-v-c46b6db2><div class="flex flex-col md:flex-row items-start md:items-center gap-6" data-v-c46b6db2><div class="w-16 h-16 rounded-xl bg-gradient-to-br from-purple-500/20 to-pink-500/20 flex items-center justify-center flex-shrink-0" data-v-c46b6db2><svg class="w-8 h-8 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-c46b6db2><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.832 5.477 9.246 5 7.5 5S4.168 5.477 3 6.253v13C4.168 18.477 5.754 18 7.5 18s3.332.477 4.5 1.253m0-13C13.168 5.477 14.754 5 16.5 5c1.747 0 3.332.477 4.5 1.253v13C19.832 18.477 18.247 18 16.5 18c-1.746 0-3.332.477-4.5 1.253" data-v-c46b6db2></path></svg></div><div class="flex-1" data-v-c46b6db2><h4 class="text-lg font-semibold text-white mb-2" data-v-c46b6db2>Continuous Learning</h4><p class="text-gray-400 text-sm mb-4" data-v-c46b6db2>Currently expanding my skills in these areas</p><div class="flex flex-wrap gap-3" data-v-c46b6db2><!--[-->`);
      ssrRenderList(learning.value, (tech) => {
        _push(`<div class="px-4 py-2 glass-light rounded-lg text-sm flex items-center gap-2" data-v-c46b6db2><span class="w-2 h-2 bg-green-400 rounded-full" data-v-c46b6db2></span><span class="text-gray-300" data-v-c46b6db2>${ssrInterpolate(tech.name)}</span></div>`);
      });
      _push(`<!--]--></div></div></div></div><div class="mt-16 animate-fadeInUp delay-500" data-v-c46b6db2><h3 class="text-lg font-semibold text-white text-center mb-6" data-v-c46b6db2>Development Ecosystem</h3><div class="flex flex-wrap justify-center gap-3" data-v-c46b6db2><!--[-->`);
      ssrRenderList(tools.value, (tool) => {
        _push(`<span class="px-4 py-2 glass-light rounded-lg text-sm text-gray-300 hover:text-blue-400 hover:border-blue-400/30 transition-all duration-300 cursor-default" data-v-c46b6db2>${ssrInterpolate(tool.name)}</span>`);
      });
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-c46b6db2"]]);
const _sfc_main$2 = {
  __name: "Projects",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        id: "projects",
        class: "portfolio-section"
      }, _attrs))} data-v-b4cde928><div class="section-overlay" data-v-b4cde928></div><div class="floating-elements" data-v-b4cde928><!--[-->`);
      ssrRenderList(12, (i) => {
        _push(`<div class="floating-circle" style="${ssrRenderStyle({
          left: `${Math.random() * 100}%`,
          top: `${Math.random() * 100}%`,
      ...
      _push(`<!--]--></div><div class="absolute inset-0 grid-pattern opacity-30" data-v-b4cde928></div><div class="section-anchor relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8" data-v-b4cde928><div class="text-center mb-12 animate-fadeInUp" data-v-b4cde928><div class="section-badge mx-auto" data-v-b4cde928><svg class="w-4 h-4 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10" data-v-b4cde928></path></svg><span data-v-b4cde928>My Work</span></div><h2 class="section-title" data-v-b4cde928> Featured <span data-v-b4cde928>Projects</span></h2><p class="section-subtitle mt-4" data-v-b4cde928> A selection of my best work, showcasing my skills and creativity </p></div><div class="flex flex-wrap justify-center gap-3 mb-10 animate-fadeInUp delay-100" data-v-b4cde928><!--[-->`);
      ssrRenderList(filters, (filter) => {
        _push(`<button class="${ssrRenderClass([activeFilter.value === filter ? "bg-gradient-to-r from-blue-500 to-cyan-500 text-white shadow-lg" : "glass-light text-gray-300 hover:text-white hover:bg-white/20", "px-4 py-2 rounded-full transition-all duration-300 text-sm"])}" data-v-b4cde928>${ssrInterpolate(filter)}</button>`);
      });
      _push(`<!--]--></div><div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6" data-v-b4cde928><!--[-->`);
      ssrRenderList(filteredProjects.value, (project, index2) => {
        _push(`<div class="${ssrRenderClass([`delay-${index2 % 5 * 100}`, "group portfolio-card p-6 animate-fadeInUp cursor-pointer hover-lift"])}" data-v-b4cde928><div class="relative h-48 rounded-xl overflow-hidden mb-4" data-v-b4cde928><img${ssrRenderAttr("src", project.image)}${ssrRenderAttr("alt", project.title)} class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" data-v-b4cde928><div class="absolute inset-0 bg-gradient-to-t from-black/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" data-v-b4cde928></div><div class="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500" data-v-b4cde928><span class="px-4 py-2 bg-white/20 backdrop-blur-sm text-white rounded-lg border border-white/30 text-sm" data-v-b4cde928> View Details </span></div><span class="absolute top-3 right-3 px-2 py-1 bg-blue-500/80 backdrop-blur-sm text-white text-xs rounded-full" data-v-b4cde928>${ssrInterpolate(project.type)}</span></div><h3 class="text-xl font-semibold text-white mb-2 group-hover:text-blue-400 transition-colors" data-v-b4cde928>${ssrInterpolate(project.title)}</h3><p class="text-gray-400 text-sm mb-4 line-clamp-2" data-v-b4cde928>${ssrInterpolate(project.description)}</p><div class="flex flex-wrap gap-2 mb-4" data-v-b4cde928><!--[-->`);
        ssrRenderList(project.tech.slice(0, 3), (tech) => {
          _push(`<span class="px-2 py-1 text-xs bg-blue-500/20 text-blue-300 rounded" data-v-b4cde928>${ssrInterpolate(tech)}</span>`);
        });
        _push(`<!--]-->`);
        if (project.tech.length > 3) {
          _push(`<span class="px-2 py-1 text-xs text-gray-400" data-v-b4cde928> +${ssrInterpolate(project.tech.length - 3)}</span>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div class="flex justify-between items-center" data-v-b4cde928><a${ssrRenderAttr("href", project.demo)} target="_blank" class="text-blue-400 hover:text-blue-300 transition-colors flex items-center gap-1 text-sm" data-v-b4cde928> Live Demo <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" data-v-b4cde928></path></svg></a><span class="text-xs text-gray-500" data-v-b4cde928>${ssrInterpolate(project.year)}</span></div></div>`);
      });
      _push(`<!--]--></div></div>`);
      ssrRenderTeleport(_push, (_push2) => {
        if (selectedProject.value) {
          _push2(`<div class="fixed inset-0 z-[9999] flex items-center justify-center p-4 md:p-6" style="${ssrRenderStyle({ "background-color": "rgba(0, 0, 0, 0.8)", "backdrop-filter": "blur(8px)" })}" data-v-b4cde928><div class="relative bg-slate-900/95 backdrop-blur-xl border border-blue-400/30 rounded-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col shadow-2xl" data-v-b4cde928><div class="sticky top-0 z-20 flex justify-between items-center p-4 md:p-6 bg-slate-900/95 backdrop-blur-xl border-b border-white/10" data-v-b4cde928><h3 class="text-xl md:text-2xl font-bold text-white truncate pr-8" data-v-b4cde928>${ssrInterpolate(selectedProject.value.title)}</h3><button class="text-gray-400 hover:text-white bg-slate-800/50 hover:bg-slate-700 rounded-full p-2 transition-colors absolute right-4 top-4" data-v-b4cde928><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M6 18L18 6M6 6l12 12" data-v-b4cde928></path></svg></button></div><div class="overflow-y-auto custom-scrollbar p-4 md:p-6 pt-2" data-v-b4cde928><div class="relative h-48 md:h-64 w-full rounded-xl overflow-hidden mb-6" data-v-b4cde928><img${ssrRenderAttr("src", selectedProject.value.image)}${ssrRenderAttr("alt", selectedProject.value.title)} class="w-full h-full object-cover" data-v-b4cde928><div class="absolute inset-0 bg-gradient-to-t from-slate-900/80 to-transparent" data-v-b4cde928></div><div class="absolute bottom-4 left-4" data-v-b4cde928><span class="inline-block px-3 py-1 bg-blue-500/80 backdrop-blur-sm text-white text-sm rounded-full" data-v-b4cde928>${ssrInterpolate(selectedProject.value.type)}</span></div></div><div class="mb-6" data-v-b4cde928><h4 class="text-lg font-semibold text-white mb-2" data-v-b4cde928>Overview</h4><p class="text-gray-300 leading-relaxed" data-v-b4cde928>${ssrInterpolate(selectedProject.value.fullDescription || selectedProject.value.description)}</p></div>`);
          if (selectedProject.value.features) {
            _push2(`<div class="mb-6" data-v-b4cde928><h4 class="text-lg font-semibold text-white mb-3" data-v-b4cde928>Key Features</h4><ul class="space-y-2" data-v-b4cde928><!--[-->`);
            ssrRenderList(selectedProject.value.features, (feature, index2) => {
              _push2(`<li class="flex items-start gap-3" data-v-b4cde928><svg class="w-5 h-5 text-blue-400 mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" data-v-b4cde928></path></svg><span class="text-gray-300" data-v-b4cde928>${ssrInterpolate(feature)}</span></li>`);
            });
            _push2(`<!--]--></ul></div>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<div class="mb-8" data-v-b4cde928><h4 class="text-lg font-semibold text-white mb-3" data-v-b4cde928>Technologies Used</h4><div class="flex flex-wrap gap-2" data-v-b4cde928><!--[-->`);
          ssrRenderList(selectedProject.value.tech, (tech) => {
            _push2(`<span class="px-3 py-1.5 text-sm bg-blue-500/20 text-blue-300 rounded-full border border-blue-500/30" data-v-b4cde928>${ssrInterpolate(tech)}</span>`);
          });
          _push2(`<!--]--></div></div><div class="flex flex-col sm:flex-row gap-3 sticky bottom-0 bg-slate-900/95 backdrop-blur-xl pt-4 -mx-2 px-2 pb-1 border-t border-white/10 mt-4" data-v-b4cde928><a${ssrRenderAttr("href", selectedProject.value.demo)} target="_blank" class="flex-1 px-4 py-3 bg-gradient-to-r from-blue-500 to-cyan-500 hover:from-blue-600 hover:to-cyan-600 text-white font-semibold rounded-lg text-center transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 text-sm md:text-base" data-v-b4cde928><svg class="w-4 h-4 md:w-5 md:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" data-v-b4cde928></path></svg> Live Demo </a>`);
          if (selectedProject.value.github) {
            _push2(`<a${ssrRenderAttr("href", selectedProject.value.github)} target="_blank" class="flex-1 px-4 py-3 bg-slate-800 hover:bg-slate-700 text-white font-semibold rounded-lg text-center transition-all duration-300 hover:scale-[1.02] flex items-center justify-center gap-2 text-sm md:text-base border border-slate-700" data-v-b4cde928><svg class="w-4 h-4 md:w-5 md:h-5" fill="currentColor" viewBox="0 0 24 24" data-v-b4cde928><path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z" data-v-b4cde928></path></svg> View Source </a>`);
          } else {
            _push2(`<!---->`);
          }
          _push2(`<button class="flex-1 px-4 py-3 bg-slate-800/50 hover:bg-slate-700/50 text-white font-semibold rounded-lg text-center transition-all duration-300 hover:scale-[1.02] border border-slate-700 text-sm md:text-base" data-v-b4cde928> Close </button></div></div></div></div>`);
        } else {
          _push2(`<!---->`);
        }
      }, "body", false, _parent);
...
const __nuxt_component_3 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$2, [["__scopeId", "data-v-b4cde928"]]), { __name: "Projects" });
const _sfc_main$1 = {
  __name: "Contact",
  __ssrInlineRender: true,
  setup(__props) {
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="fixed inset-0 -z-10" data-v-159c5354><div class="absolute inset-0 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900" data-v-159c5354></div><div class="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-transparent via-slate-900/20 to-slate-900" data-v-159c5354></div></div><div class="relative z-0 min-h-screen overflow-x-hidden" data-v-159c5354><div class="fixed top-0 left-0 right-0 h-1 bg-gradient-to-r from-cyan-500 via-blue-500 to-purple-500 z-50 origin-left transition-transform duration-150" style="${ssrRenderStyle({ transform: `scaleX(${scrollProgress.value})` })}" data-v-159c5354></div><main class="pt-16" data-v-159c5354>`);
      ...
      if (showBackToTop.value) {
        _push(`<button class="fixed bottom-8 right-8 z-40 p-3 bg-slate-800/90 backdrop-blur-sm rounded-full border border-slate-700 hover:bg-slate-700/90 transition-all duration-300 hover:scale-110 group shadow-lg hover:shadow-cyan-500/20" aria-label="Back to top" title="Back to top" data-v-159c5354><svg class="w-6 h-6 text-cyan-400 group-hover:text-white transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-159c5354><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 10l7-7m0 0l7 7m-7-7v18" data-v-159c5354></path></svg></button>`);
      } else {
        _push(`<!---->`);
      }
      if (showScrollHint.value) {
        _push(`<div class="fixed bottom-8 left-1/2 transform -translate-x-1/2 z-30" data-v-159c5354><div class="flex flex-col items-center text-sm text-slate-400 bg-slate-900/50 backdrop-blur-sm px-4 py-2 rounded-full border border-slate-800" data-v-159c5354><span class="mb-1" data-v-159c5354>Scroll to explore</span><svg class="w-4 h-4 animate-bounce" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-159c5354><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 14l-7 7m0 0l-7-7m7 7V3" data-v-159c5354></path></svg></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (isLoading.value) {
        _push(`<div class="fixed inset-0 z-50 flex items-center justify-center bg-slate-900" data-v-159c5354><div class="animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-cyan-500" data-v-159c5354></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><!--]-->`);
...
const index = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-159c5354"]]);

export { index as default };
//# sourceMappingURL=index-BCWQIDv0.mjs.map
