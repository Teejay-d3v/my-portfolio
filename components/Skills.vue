  ...
  >
    ...
    <div class="absolute inset-0">
      <div v-for="i in 15" :key="i" 
           class="absolute text-blue-400/10"
           :style="{
             left: `${Math.random() * 100}%`,
             top: `${Math.random() * 100}%`,
        ...
        <div v-html="getRandomTechIcon()"></div>
      </div>
    </div>
    ...
    <div class="relative z-10 w-full max-w-7xl mx-auto">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="group bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:border-blue-400/50 transition-all duration-300 animate-fadeIn">
          ...
          <div class="grid grid-cols-3 gap-4">
            <div
              ...
              :key="skill.name"
              class="group flex flex-col items-center justify-center bg-slate-800/30 rounded-xl p-4 hover:bg-slate-700/50 hover:scale-105 transition-all duration-300"
            >
              <div
                class="w-10 h-10 mb-2 transition-transform duration-500 group-hover:scale-110 group-hover:rotate-6"
                v-html="skill.svg"
              ></div>
              <span class="text-sm text-gray-300 text-center">{{ skill.name }}</span>
            </div>
          </div>
        </div>
        ...
        <div class="group bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:border-blue-400/50 transition-all duration-300 animate-fadeIn delay-200">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-xl font-semibold text-white">Backend & Tools</h3>
          </div>
        ...
        <!-- Additional Skills -->
        <div class="group bg-white/5 backdrop-blur-xl border border-white/20 rounded-2xl p-6 hover:border-blue-400/50 transition-all duration-300 animate-fadeIn delay-400">
          <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-xl font-semibold text-white">Additional Skills</h3>
          </div>
          ...
          <div class="space-y-4">
            <div class="grid grid-cols-2 gap-3">
              <div
                ...
                :key="skill.name"
                class="group flex items-center gap-3 bg-slate-800/30 rounded-lg p-3 hover:bg-slate-700/50 transition-all duration-300"
              >
                <div class="w-8 h-8" v-html="skill.svg"></div>
      ...
      <div class="mt-12 bg-gradient-to-r from-blue-900/20 to-cyan-900/20 backdrop-blur-sm border border-blue-400/20 rounded-2xl p-6 animate-fadeIn delay-600">
        <div class="flex flex-col md:flex-row items-center justify-between gap-6">
          <div class="flex-1">
            <h3 class="text-xl font-semibold text-white mb-2">🚀 Always Learning</h3>
            <p class="text-gray-300">
              Currently exploring <span class="text-blue-400 font-semibold">React/Next.js</span>, 
              <span class="text-blue-400 font-semibold">Three.js</span>, and 
              <span class="text-blue-400 font-semibold">Cloud Infrastructure</span> to expand my full-stack capabilities.
            </p>
          </div>
          <div class="flex gap-3">
            <span class="px-4 py-2 bg-blue-500/20 text-blue-300 rounded-full text-sm">React</span>
            <span class="px-4 py-2 bg-purple-500/20 text-purple-300 rounded-full text-sm">Three.js</span>
            <span class="px-4 py-2 bg-green-500/20 text-green-300 rounded-full text-sm">AWS</span>
          </div>
        </div>
      </div>
...
// Function to get random tech icon for background
const getRandomTechIcon = () => {
  const icons = [
    '<svg viewBox="0 0 128 128"><path fill="#41b883" d="M78.8,10L64,35.4L49.2,10H0l64,110l64-110C128,10,78.8,10,78.8,10z"></path><path fill="#35495e" d="M78.8,10L64,35.4L49.2,10H25.6L64,76l38.4-66H78.8z"></path></svg>',
    '<svg viewBox="0 0 128 128"><path fill="#f0db4f" d="M1.408 1.408h125.184v125.185H1.408z"></path></svg>',
    '<svg viewBox="0 0 128 128"><path fill="#007acc" d="M2 63.91v62.5h125v-125H2zm100.73-5a15.56 15.56 0 017.82 4.5 20.58 20.58 0 013 4c0 .16-5.4 3.81-8.69 5.85-.12.08-.6-.44-1.13-1.23a7.09 7.09 0 00-5.87-3.53c-3.79-.26-6.23 1.73-6.21 5a4.58 4.58 0 00.54 2.34c.83 1.73 2.38 2.76 7.24 4.86 8.95 3.85 12.78 6.39 15.16 10 2.66 4 3.25 10.46 1.45 15.24-2 5.2-6.9 8.73-13.83 9.9a38.32 38.32 0 01-9.52-.1 23 23 0 01-12.72-6.63c-1.15-1.27-3.39-4.58-3.25-4.82a9.34 9.34 0 011.15-.73L82 101l3.59-2.08.75 1.11a16.78 16.78 0 004.74 4.54c4 2.1 9.46 1.81 12.16-.62a5.43 5.43 0 00.69-6.92c-1-1.39-3-2.56-8.59-5-6.45-2.78-9.23-4.5-11.77-7.24a16.48 16.48 0 01-3.43-6.25 25 25 0 01-.22-8c1.33-6.23 6-10.58 12.82-11.87a31.66 31.66 0 019.49.26zm-29.34 5.24v5.12H56.66v46.23H45.15V69.26H28.88v-5a49.19 49.19 0 01.12-5.17C29.08 59 39 59 51 59h21.83z"></path></svg>',
...
const skills = [
  ...
  },
  {
    ...
    level: 'Intermediate',
    svg: `<svg viewBox="0 0 128 128">
          <path fill="#284e64" d="M72.347 76.92l.01-.066 4.103-24.015zm29.629-24.14L88.667 76.842l13.315-24.057 14.544-26.382zm.453-47.19l-4.272 7.81zM22.26 46.707l16.317-17.542zm3.47 6.347l18.027-14.32zm0 0l-1.205-2.208 1.206 2.208 12.824 23.534zm4.503-8.353L38.58 29.2l15.242 28.053-15.24-28.07L25.673 5.59l12.903 23.599zm37.564 38.29l.054.11 2.416 4.445zM84.85 37.598l-8.4 15.205-9.348 17.204 9.348-17.2zm0 0"></path><path fill="#f16827" d="M51.367 100.218l12.129 22.217 6.671-34.312zm0 0"></path><path fill="#f48029" d="M70.272 87.575l-10.7-19.67-8.205 32.313 18.8-12.095zm0 0"></path><path fill="#f89a2e" d="M38.548 76.59l12.814 23.628 8.21-32.312zm0 0"></path><path fill="#f16827" d="M38.548 76.59l21.024-8.69L43.76 38.73zm0 0"></path><path fill="#f89921" d="M72.347 76.92L76.46 52.84 63.914 75.905l6.352 11.669zm0 0"></path><path fill="#f89a2e" d="M25.73 53.054L38.55 76.589l5.209-37.849zm0 0"></path><path fill="#f48029" d="M88.657 76.841l13.319-24.06-29.62 24.071zm0 0"></path><path fill="#f4ae5c" d="M38.58 29.198L25.73 53.053l18.027-14.318zm33.78 47.654l17.067-47.506-12.965 23.493zm0 0"></path><path fill="#cd4e27" d="M25.73 53.054l12.85-23.856-16.326 17.517 2.275 4.133zm0 0"></path><path fill="#f16938" d="M101.97 52.78L89.42 29.346 72.36 76.852zm-79.71-6.072l16.317-17.542-12.91-23.601-3.412 41.121zm0 0"></path><path fill="#f89a2e" d="M101.97 52.78l.464-47.19-13.009 23.756zM25.668 5.584H0l22.26 41.124zm0 0"></path><path fill="#cd4e27" d="M102.434 5.59l-.464 47.19L128 5.584zM72.357 76.852l-.01.067-8.852 45.512 25.168-45.585zm0 0"></path>
          </svg>`
  },
  {
    name: 'MySQL',
...
const frontendSkills = skills.filter(skill => 
  ['Vue 3', 'Nuxt 3', 'JavaScript', 'TypeScript', 'Tailwind CSS', 'HTML5', 'CSS3'].includes(skill.name)
)

const backendSkills = skills.filter(skill => 
  ['REST API', 'MySQL', 'Laravel', 'Supabase'].includes(skill.name)
)

const additionalSkills = [
  {
    name: 'Git',
    svg: `<svg class="w-8 h-8" viewBox="0 0 128 128"><path fill="#F34F29" d="M124.737 58.378L69.621 3.264c-3.172-3.174-8.32-3.174-11.497 0L46.68 14.71l14.518 14.518c3.375-1.139 7.243-.375 9.932 2.314 2.703 2.706 3.461 6.607 2.294 9.993l13.992 13.993c3.385-1.167 7.292-.413 9.994 2.295 3.78 3.777 3.78 9.9 0 13.679a9.673 9.673 0 01-13.683 0 9.677 9.677 0 01-2.105-10.521L68.574 47.933l-.002 34.341a9.708 9.708 0 012.559 1.828c3.778 3.777 3.778 9.898 0 13.683-3.779 3.777-9.904 3.777-13.679 0-3.778-3.784-3.778-9.905 0-13.683a9.65 9.65 0 013.167-2.11V47.333a9.581 9.581 0 01-3.167-2.111c-2.862-2.86-3.551-7.06-2.083-10.576L41.056 20.333 3.264 58.123a8.133 8.133 0 000 11.5l55.117 55.114c3.174 3.174 8.32 3.174 11.499 0l54.858-54.858a8.135 8.135 0 00-.001-11.501z"></path></svg>`
  },
  {
    name: 'Vitest',
    svg: `<svg class="w-8 h-8" viewBox="0 0 128 128"><path fill="#284e64" d="M72.347 76.92l.01-.066 4.103-24.015zm29.629-24.14L88.667 76.842l13.315-24.057 14.544-26.382zm.453-47.19l-4.272 7.81zM22.26 46.707l16.317-17.542zm3.47 6.347l18.027-14.32zm0 0l-1.205-2.208 1.206 2.208 12.824 23.534zm4.503-8.353L38.58 29.2l15.242 28.053-15.24-28.07L25.673 5.59l12.903 23.599zm37.564 38.29l.054.11 2.416 4.445zM84.85 37.598l-8.4 15.205-9.348 17.204 9.348-17.2zm0 0"></path><path fill="#f16827" d="M51.367 100.218l12.129 22.217 6.671-34.312zm0 0"></path><path fill="#f48029" d="M70.272 87.575l-10.7-19.67-8.205 32.313 18.8-12.095zm0 0"></path><path fill="#f89a2e" d="M38.548 76.59l12.814 23.628 8.21-32.312zm0 0"></path><path fill="#f16827" d="M38.548 76.59l21.024-8.69L43.76 38.73zm0 0"></path><path fill="#f89921" d="M72.347 76.92L76.46 52.84 63.914 75.905l6.352 11.669zm0 0"></path><path fill="#f89a2e" d="M25.73 53.054L38.55 76.589l5.209-37.849zm0 0"></path><path fill="#f48029" d="M88.657 76.841l13.319-24.06-29.62 24.071zm0 0"></path><path fill="#f4ae5c" d="M38.58 29.198L25.73 53.053l18.027-14.318zm33.78 47.654l17.067-47.506-12.965 23.493zm0 0"></path><path fill="#cd4e27" d="M25.73 53.054l12.85-23.856-16.326 17.517 2.275 4.133zm0 0"></path><path fill="#f16938" d="M101.97 52.78L89.42 29.346 72.36 76.852zm-79.71-6.072l16.317-17.542-12.91-23.601-3.412 41.121zm0 0"></path><path fill="#f89a2e" d="M101.97 52.78l.464-47.19-13.009 23.756zM25.668 5.584H0l22.26 41.124zm0 0"></path><path fill="#cd4e27" d="M102.434 5.59l-.464 47.19L128 5.584zM72.357 76.852l-.01.067-8.852 45.512 25.168-45.585zm0 0"></path></svg>`
  },
]

// Featured skills for the highlight section
const featuredSkills = [
  {
    name: 'Vue 3',
    description: 'Modern reactive framework',
    svg: skills.find(s => s.name === 'Vue 3').svg,
    delay: 0
  },
  {
    name: 'Nuxt 3',
    description: 'Full-stack Vue framework',
    svg: skills.find(s => s.name === 'Nuxt 3').svg,
    delay: 100
  },
  {
    name: 'Tailwind CSS',
    description: 'Utility-first CSS framework',
    svg: skills.find(s => s.name === 'Tailwind CSS').svg,
    delay: 200
  },
  {
    name: 'TypeScript',
    description: 'Typed JavaScript',
    svg: skills.find(s => s.name === 'TypeScript').svg,
    delay: 300
  },
]
</script>
...
.border-gradient {
  ...
  background: linear-gradient(to right, rgba(59, 130, 246, 0.1), rgba(59, 130, 246, 0.1)) padding-box,
              linear-gradient(45deg, rgba(59, 130, 246, 0.5), rgba(147, 51, 234, 0.5)) border-box;
}
